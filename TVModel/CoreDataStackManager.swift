...
private let SQLITE_FILE_NAME = "TravisViewer.sqlite"
...
public class CoreDataStackManager {
    ...
    */
    ...
    public static let instance = CoreDataStackManager()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("TravisViewer", withExtension: "momd")!
